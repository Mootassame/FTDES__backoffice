...
const schema = yup.object().shape({
  ...
  fonction: yupFilterSchemas.enumerator(
    i18n('user.fields.fonction'),
  ),
  region: yupFilterSchemas.enumerator(
    i18n('user.fields.region'),
  ),
  pays: yupFilterSchemas.enumerator(
    i18n('user.fields.pays'),
  ),
});
...
const previewRenders = {
  ...
  pays: {
    ...
    render: (value) =>
      value ? i18n(`user.enumerators.pays.${value}`) : null,
  },

  status: {
    label: i18n('user.fields.enumerators.status'),
