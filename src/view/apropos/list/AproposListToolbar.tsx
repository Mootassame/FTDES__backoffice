...
const AproposToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    aproposSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    aproposSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=apropos">
