...
const schema = yup.object().shape({
  ...
  objectifs: yupFilterSchemas.string(
    i18n('entities.apropos.fields.objectifs'),
  ),
  services: yupFilterSchemas.string(
    i18n('entities.apropos.fields.services'),
  ),
  contacts: yupFilterSchemas.string(
...
export default AproposListFilter;