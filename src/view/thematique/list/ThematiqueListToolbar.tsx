...
const ThematiqueToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    thematiqueSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    thematiqueSelectors.selectPermissionToImport,
  );
...
"fa-regular fa-square-plus"></i>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=thematique">
...
export default ThematiqueToolbar;
