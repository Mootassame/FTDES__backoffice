...
const ViolenceToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    violenceSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    violenceSelectors.selectPermissionToImport,
  );
...
"fa-regular fa-square-plus"></i>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=violence">
...
export default ViolenceToolbar;
