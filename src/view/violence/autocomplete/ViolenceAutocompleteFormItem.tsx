...
import ViolenceFormModal from 'src/view/violence/form/ViolenceFormModal';
...
const ViolenceAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return ViolenceService.listAutocomplete(value, limit);
  };
...
export default ViolenceAutocompleteFormItem;
