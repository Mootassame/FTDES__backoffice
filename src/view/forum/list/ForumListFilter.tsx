...
const schema = yup.object().shape({
  ...
  sujet: yupFilterSchemas.string(
    i18n('entities.forum.fields.sujet'),
  ),
  visibilite: yupFilterSchemas.enumerator(
...
const previewRenders = {
  ...
  visibilite: {
    ...
    render: filterRenders.enumerator(
      'entities.forum.enumerators.visibilite',
    ),
  },
  statut: {
    label: i18n('entities.forum.fields.statut'),
    render: filterRenders.enumerator(
      'entities.forum.enumerators.statut',
    ),
  },
};

const ForumListFilter = (props) => {
...
export default ForumListFilter;
