...
import ForumFormModal from 'src/view/forum/form/ForumFormModal';
...
const ForumAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return ForumService.listAutocomplete(value, limit);
  };
...
export default ForumAutocompleteFormItem;
