...
const schema = yup.object().shape({
  title: yupFilterSchemas.string(
    i18n('entities.domaine.fields.title'),
  ),
  description: yupFilterSchemas.string(
    i18n('entities.domaine.fields.description'),
  ),
});
...
const previewRenders = {
  ...
  description: {
    label: i18n('entities.domaine.fields.description'),
    render: filterRenders.generic(),
  },
};

const DomaineListFilter = (props) => {
...
export default DomaineListFilter;
